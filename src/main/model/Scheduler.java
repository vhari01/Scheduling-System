...
public class Scheduler {
    ...
    public String addPatient(Patient p1) {
        ...
        EventLog.getInstance()
                .logEvent(new Event("Patient added: " + p1.getPatientName() + ", Booking ID: " + bookingId));
        return bookingId;
    ...
    public ArrayList<Patient> sortPatientsByPriority() {
        ...
        EventLog.getInstance()
                .logEvent(new Event("Patients sorted by priority. Total patients: " + patientsSorted.size()));
